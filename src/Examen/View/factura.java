...
public class factura extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("\"MegaCalzado Shoes\"");
        ...
        jTnumfac.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTnumfacActionPerformed(evt);
            }
        });
        getContentPane().add(jTnumfac, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 70, 70, 25));
...
if(JOptionPane.showConfirmDialog(rootPane, "Ya esta listo para imprimir la Factura?","Imprimir Factura",1)==0){
    ...
    int e;
        ...
        try {
                ...
                con.ejecutar("INSERT INTO `zapateria`.`facturas` (`cantidad`, `nombre`, `direccion`, `rfc`) VALUES ('"+total+"', '"+nomfac+"', '"+direccionfac+"', '"+rfcfac+"');");
//                int to[] = new int[100];
...
// TODO add your handling code here:
    ...
    private void jTnumfacActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTnumfacActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTnumfacActionPerformed
